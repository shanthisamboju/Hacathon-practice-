...
propertydict = {}
with open(r"C:/Users/SHANTHISAMBOJU/Python_training_13th_17th_April_2020/HACATHON_Project_20th_May/healthplannerPythonAPI-master/static/properties.txt") as pfile:
    for line in pfile:
...
Collection=db.getCollectionNames();# added to get the collections in current db
users=db.getUsers()

patientrecords = db.collection
print("****************************\npatient list in the mongodb dabase{} is {}\n************************ ".format(properties.mongodbname,patientrecords))
